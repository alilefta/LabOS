...
export const ClinicFindManySelectSchema: z.ZodType<Prisma.ClinicSelect> = z.object({
...
export const ClinicFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    labId: z.boolean().optional(),
    lab: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const ClinicFindManySchema: z.ZodType<Prisma.ClinicFindManyArgs> = z.object({ select: ClinicFindManySelectSchema.optional(), include: z.lazy(() => ClinicIncludeObjectSchema.optional()), orderBy: z.union([ClinicOrderByWithRelationInputObjectSchema, ClinicOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClinicWhereInputObjectSchema.optional(), cursor: ClinicWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClinicScalarFieldEnumSchema, ClinicScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClinicFindManyArgs>;

export const ClinicFindManyZodSchema = z.object({ select: ClinicFindManySelectSchema.optional(), include: z.lazy(() => ClinicIncludeObjectSchema.optional()), orderBy: z.union([ClinicOrderByWithRelationInputObjectSchema, ClinicOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClinicWhereInputObjectSchema.optional(), cursor: ClinicWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClinicScalarFieldEnumSchema, ClinicScalarFieldEnumSchema.array()]).optional() }).strict();