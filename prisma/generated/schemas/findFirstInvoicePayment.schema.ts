...
export const InvoicePaymentFindFirstSelectSchema: z.ZodType<Prisma.InvoicePaymentSelect> = z.object({
...
export const InvoicePaymentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    invoiceId: z.boolean().optional(),
    invoice: z.boolean().optional(),
    labId: z.boolean().optional(),
...
export const InvoicePaymentFindFirstSchema: z.ZodType<Prisma.InvoicePaymentFindFirstArgs> = z.object({ select: InvoicePaymentFindFirstSelectSchema.optional(), include: z.lazy(() => InvoicePaymentIncludeObjectSchema.optional()), orderBy: z.union([InvoicePaymentOrderByWithRelationInputObjectSchema, InvoicePaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: InvoicePaymentWhereInputObjectSchema.optional(), cursor: InvoicePaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InvoicePaymentScalarFieldEnumSchema, InvoicePaymentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InvoicePaymentFindFirstArgs>;

export const InvoicePaymentFindFirstZodSchema = z.object({ select: InvoicePaymentFindFirstSelectSchema.optional(), include: z.lazy(() => InvoicePaymentIncludeObjectSchema.optional()), orderBy: z.union([InvoicePaymentOrderByWithRelationInputObjectSchema, InvoicePaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: InvoicePaymentWhereInputObjectSchema.optional(), cursor: InvoicePaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InvoicePaymentScalarFieldEnumSchema, InvoicePaymentScalarFieldEnumSchema.array()]).optional() }).strict();