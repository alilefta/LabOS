...
export const CaseWorkItemFindManySelectSchema: z.ZodType<Prisma.CaseWorkItemSelect> = z.object({
...
export const CaseWorkItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    productId: z.boolean().optional(),
    product: z.boolean().optional(),
    labId: z.boolean().optional(),
...
export const CaseWorkItemFindManySchema: z.ZodType<Prisma.CaseWorkItemFindManyArgs> = z.object({ select: CaseWorkItemFindManySelectSchema.optional(), include: z.lazy(() => CaseWorkItemIncludeObjectSchema.optional()), orderBy: z.union([CaseWorkItemOrderByWithRelationInputObjectSchema, CaseWorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseWorkItemWhereInputObjectSchema.optional(), cursor: CaseWorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseWorkItemScalarFieldEnumSchema, CaseWorkItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CaseWorkItemFindManyArgs>;

export const CaseWorkItemFindManyZodSchema = z.object({ select: CaseWorkItemFindManySelectSchema.optional(), include: z.lazy(() => CaseWorkItemIncludeObjectSchema.optional()), orderBy: z.union([CaseWorkItemOrderByWithRelationInputObjectSchema, CaseWorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseWorkItemWhereInputObjectSchema.optional(), cursor: CaseWorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseWorkItemScalarFieldEnumSchema, CaseWorkItemScalarFieldEnumSchema.array()]).optional() }).strict();