...
export const AuthUserFindManySelectSchema: z.ZodType<Prisma.AuthUserSelect> = z.object({
...
export const AuthUserFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    emailVerified: z.boolean().optional(),
...
export const AuthUserFindManySchema: z.ZodType<Prisma.AuthUserFindManyArgs> = z.object({ select: AuthUserFindManySelectSchema.optional(), include: z.lazy(() => AuthUserIncludeObjectSchema.optional()), orderBy: z.union([AuthUserOrderByWithRelationInputObjectSchema, AuthUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: AuthUserWhereInputObjectSchema.optional(), cursor: AuthUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AuthUserScalarFieldEnumSchema, AuthUserScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AuthUserFindManyArgs>;

export const AuthUserFindManyZodSchema = z.object({ select: AuthUserFindManySelectSchema.optional(), include: z.lazy(() => AuthUserIncludeObjectSchema.optional()), orderBy: z.union([AuthUserOrderByWithRelationInputObjectSchema, AuthUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: AuthUserWhereInputObjectSchema.optional(), cursor: AuthUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AuthUserScalarFieldEnumSchema, AuthUserScalarFieldEnumSchema.array()]).optional() }).strict();