...
export const AuthUserFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AuthUserSelect> = z.object({
...
export const AuthUserFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    emailVerified: z.boolean().optional(),
