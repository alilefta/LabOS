...
export const ClinicFindFirstOrThrowSchema: z.ZodType<Prisma.ClinicFindFirstOrThrowArgs> = z.object({ select: ClinicFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClinicIncludeObjectSchema.optional()), orderBy: z.union([ClinicOrderByWithRelationInputObjectSchema, ClinicOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClinicWhereInputObjectSchema.optional(), cursor: ClinicWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClinicScalarFieldEnumSchema, ClinicScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClinicFindFirstOrThrowArgs>;

export const ClinicFindFirstOrThrowZodSchema = z.object({ select: ClinicFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClinicIncludeObjectSchema.optional()), orderBy: z.union([ClinicOrderByWithRelationInputObjectSchema, ClinicOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClinicWhereInputObjectSchema.optional(), cursor: ClinicWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClinicScalarFieldEnumSchema, ClinicScalarFieldEnumSchema.array()]).optional() }).strict();