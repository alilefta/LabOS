...
export const StaffPayoutFindFirstSelectSchema: z.ZodType<Prisma.StaffPayoutSelect> = z.object({
...
export const StaffPayoutFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    payoutNumber: z.boolean().optional(),
    labId: z.boolean().optional(),
    lab: z.boolean().optional(),
...
export const StaffPayoutFindFirstSchema: z.ZodType<Prisma.StaffPayoutFindFirstArgs> = z.object({ select: StaffPayoutFindFirstSelectSchema.optional(), include: z.lazy(() => StaffPayoutIncludeObjectSchema.optional()), orderBy: z.union([StaffPayoutOrderByWithRelationInputObjectSchema, StaffPayoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffPayoutWhereInputObjectSchema.optional(), cursor: StaffPayoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffPayoutScalarFieldEnumSchema, StaffPayoutScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffPayoutFindFirstArgs>;

export const StaffPayoutFindFirstZodSchema = z.object({ select: StaffPayoutFindFirstSelectSchema.optional(), include: z.lazy(() => StaffPayoutIncludeObjectSchema.optional()), orderBy: z.union([StaffPayoutOrderByWithRelationInputObjectSchema, StaffPayoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffPayoutWhereInputObjectSchema.optional(), cursor: StaffPayoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffPayoutScalarFieldEnumSchema, StaffPayoutScalarFieldEnumSchema.array()]).optional() }).strict();