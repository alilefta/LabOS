...
export const CaseWorkItemAddonFindFirstSelectSchema: z.ZodType<Prisma.CaseWorkItemAddonSelect> = z.object({
...
export const CaseWorkItemAddonFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    caseWorkItemId: z.boolean().optional(),
    caseWorkItem: z.boolean().optional(),
    addonId: z.boolean().optional(),
...
export const CaseWorkItemAddonFindFirstSchema: z.ZodType<Prisma.CaseWorkItemAddonFindFirstArgs> = z.object({ select: CaseWorkItemAddonFindFirstSelectSchema.optional(), include: z.lazy(() => CaseWorkItemAddonIncludeObjectSchema.optional()), orderBy: z.union([CaseWorkItemAddonOrderByWithRelationInputObjectSchema, CaseWorkItemAddonOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseWorkItemAddonWhereInputObjectSchema.optional(), cursor: CaseWorkItemAddonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseWorkItemAddonScalarFieldEnumSchema, CaseWorkItemAddonScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CaseWorkItemAddonFindFirstArgs>;

export const CaseWorkItemAddonFindFirstZodSchema = z.object({ select: CaseWorkItemAddonFindFirstSelectSchema.optional(), include: z.lazy(() => CaseWorkItemAddonIncludeObjectSchema.optional()), orderBy: z.union([CaseWorkItemAddonOrderByWithRelationInputObjectSchema, CaseWorkItemAddonOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseWorkItemAddonWhereInputObjectSchema.optional(), cursor: CaseWorkItemAddonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseWorkItemAddonScalarFieldEnumSchema, CaseWorkItemAddonScalarFieldEnumSchema.array()]).optional() }).strict();