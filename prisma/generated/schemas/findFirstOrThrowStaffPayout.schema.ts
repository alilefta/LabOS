...
export const StaffPayoutFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StaffPayoutSelect> = z.object({
...
export const StaffPayoutFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    payoutNumber: z.boolean().optional(),
    labId: z.boolean().optional(),
    lab: z.boolean().optional(),
...
export const StaffPayoutFindFirstOrThrowSchema: z.ZodType<Prisma.StaffPayoutFindFirstOrThrowArgs> = z.object({ select: StaffPayoutFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StaffPayoutIncludeObjectSchema.optional()), orderBy: z.union([StaffPayoutOrderByWithRelationInputObjectSchema, StaffPayoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffPayoutWhereInputObjectSchema.optional(), cursor: StaffPayoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffPayoutScalarFieldEnumSchema, StaffPayoutScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StaffPayoutFindFirstOrThrowArgs>;

export const StaffPayoutFindFirstOrThrowZodSchema = z.object({ select: StaffPayoutFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StaffPayoutIncludeObjectSchema.optional()), orderBy: z.union([StaffPayoutOrderByWithRelationInputObjectSchema, StaffPayoutOrderByWithRelationInputObjectSchema.array()]).optional(), where: StaffPayoutWhereInputObjectSchema.optional(), cursor: StaffPayoutWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StaffPayoutScalarFieldEnumSchema, StaffPayoutScalarFieldEnumSchema.array()]).optional() }).strict();