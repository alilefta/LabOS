...
export const LabInvitationFindFirstSelectSchema: z.ZodType<Prisma.LabInvitationSelect> = z.object({
...
export const LabInvitationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    token: z.boolean().optional(),
    email: z.boolean().optional(),
    labId: z.boolean().optional(),
...
export const LabInvitationFindFirstSchema: z.ZodType<Prisma.LabInvitationFindFirstArgs> = z.object({ select: LabInvitationFindFirstSelectSchema.optional(), include: z.lazy(() => LabInvitationIncludeObjectSchema.optional()), orderBy: z.union([LabInvitationOrderByWithRelationInputObjectSchema, LabInvitationOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabInvitationWhereInputObjectSchema.optional(), cursor: LabInvitationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabInvitationScalarFieldEnumSchema, LabInvitationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LabInvitationFindFirstArgs>;

export const LabInvitationFindFirstZodSchema = z.object({ select: LabInvitationFindFirstSelectSchema.optional(), include: z.lazy(() => LabInvitationIncludeObjectSchema.optional()), orderBy: z.union([LabInvitationOrderByWithRelationInputObjectSchema, LabInvitationOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabInvitationWhereInputObjectSchema.optional(), cursor: LabInvitationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabInvitationScalarFieldEnumSchema, LabInvitationScalarFieldEnumSchema.array()]).optional() }).strict();