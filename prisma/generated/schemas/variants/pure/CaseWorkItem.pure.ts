...
// prettier-ignore
export const CaseWorkItemModelSchema = z.object({
    id: z.string(),
    ...
    casePricingPlan: z.unknown().nullable(),
    totalPrice: z.number(),
...
export type CaseWorkItemPureType = z.infer<typeof CaseWorkItemModelSchema>;
