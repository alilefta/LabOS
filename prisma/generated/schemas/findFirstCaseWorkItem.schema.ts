...
export const CaseWorkItemFindFirstSelectSchema: z.ZodType<Prisma.CaseWorkItemSelect> = z.object({
...
export const CaseWorkItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    productId: z.boolean().optional(),
    product: z.boolean().optional(),
    labId: z.boolean().optional(),
...
export const CaseWorkItemFindFirstSchema: z.ZodType<Prisma.CaseWorkItemFindFirstArgs> = z.object({ select: CaseWorkItemFindFirstSelectSchema.optional(), include: z.lazy(() => CaseWorkItemIncludeObjectSchema.optional()), orderBy: z.union([CaseWorkItemOrderByWithRelationInputObjectSchema, CaseWorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseWorkItemWhereInputObjectSchema.optional(), cursor: CaseWorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseWorkItemScalarFieldEnumSchema, CaseWorkItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CaseWorkItemFindFirstArgs>;

export const CaseWorkItemFindFirstZodSchema = z.object({ select: CaseWorkItemFindFirstSelectSchema.optional(), include: z.lazy(() => CaseWorkItemIncludeObjectSchema.optional()), orderBy: z.union([CaseWorkItemOrderByWithRelationInputObjectSchema, CaseWorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseWorkItemWhereInputObjectSchema.optional(), cursor: CaseWorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseWorkItemScalarFieldEnumSchema, CaseWorkItemScalarFieldEnumSchema.array()]).optional() }).strict();