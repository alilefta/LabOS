...
export const CaseCategoryFindFirstSelectSchema: z.ZodType<Prisma.CaseCategorySelect> = z.object({
...
export const CaseCategoryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    imageUrl: z.boolean().optional(),
...
export const CaseCategoryFindFirstSchema: z.ZodType<Prisma.CaseCategoryFindFirstArgs> = z.object({ select: CaseCategoryFindFirstSelectSchema.optional(), include: z.lazy(() => CaseCategoryIncludeObjectSchema.optional()), orderBy: z.union([CaseCategoryOrderByWithRelationInputObjectSchema, CaseCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseCategoryWhereInputObjectSchema.optional(), cursor: CaseCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseCategoryScalarFieldEnumSchema, CaseCategoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CaseCategoryFindFirstArgs>;

export const CaseCategoryFindFirstZodSchema = z.object({ select: CaseCategoryFindFirstSelectSchema.optional(), include: z.lazy(() => CaseCategoryIncludeObjectSchema.optional()), orderBy: z.union([CaseCategoryOrderByWithRelationInputObjectSchema, CaseCategoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CaseCategoryWhereInputObjectSchema.optional(), cursor: CaseCategoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CaseCategoryScalarFieldEnumSchema, CaseCategoryScalarFieldEnumSchema.array()]).optional() }).strict();