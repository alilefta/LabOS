...
export const ProductAddonFindManySelectSchema: z.ZodType<Prisma.ProductAddonSelect> = z.object({
...
export const ProductAddonFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    productId: z.boolean().optional(),
    product: z.boolean().optional(),
    labId: z.boolean().optional(),
...
export const ProductAddonFindManySchema: z.ZodType<Prisma.ProductAddonFindManyArgs> = z.object({ select: ProductAddonFindManySelectSchema.optional(), include: z.lazy(() => ProductAddonIncludeObjectSchema.optional()), orderBy: z.union([ProductAddonOrderByWithRelationInputObjectSchema, ProductAddonOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductAddonWhereInputObjectSchema.optional(), cursor: ProductAddonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductAddonScalarFieldEnumSchema, ProductAddonScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductAddonFindManyArgs>;

export const ProductAddonFindManyZodSchema = z.object({ select: ProductAddonFindManySelectSchema.optional(), include: z.lazy(() => ProductAddonIncludeObjectSchema.optional()), orderBy: z.union([ProductAddonOrderByWithRelationInputObjectSchema, ProductAddonOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductAddonWhereInputObjectSchema.optional(), cursor: ProductAddonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductAddonScalarFieldEnumSchema, ProductAddonScalarFieldEnumSchema.array()]).optional() }).strict();