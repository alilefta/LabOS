...
export const LabStaffInvitationIntentDeleteOneSchema: z.ZodType<Prisma.LabStaffInvitationIntentDeleteArgs> = z.object({ select: LabStaffInvitationIntentSelectObjectSchema.optional(), include: LabStaffInvitationIntentIncludeObjectSchema.optional(), where: LabStaffInvitationIntentWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.LabStaffInvitationIntentDeleteArgs>;

export const LabStaffInvitationIntentDeleteOneZodSchema = z.object({ select: LabStaffInvitationIntentSelectObjectSchema.optional(), include: LabStaffInvitationIntentIncludeObjectSchema.optional(), where: LabStaffInvitationIntentWhereUniqueInputObjectSchema }).strict();