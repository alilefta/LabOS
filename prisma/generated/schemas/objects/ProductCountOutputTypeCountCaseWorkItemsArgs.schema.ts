...
export const ProductCountOutputTypeCountCaseWorkItemsArgsObjectSchema = makeSchema();
export const ProductCountOutputTypeCountCaseWorkItemsArgsObjectZodSchema = makeSchema();
