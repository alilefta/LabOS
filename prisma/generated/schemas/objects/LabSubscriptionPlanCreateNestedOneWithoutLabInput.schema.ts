...
export const LabSubscriptionPlanCreateNestedOneWithoutLabInputObjectSchema: z.ZodType<Prisma.LabSubscriptionPlanCreateNestedOneWithoutLabInput> = makeSchema() as unknown as z.ZodType<Prisma.LabSubscriptionPlanCreateNestedOneWithoutLabInput>;
export const LabSubscriptionPlanCreateNestedOneWithoutLabInputObjectZodSchema = makeSchema();
