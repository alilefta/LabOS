...
export const CaseCountOutputTypeCountCaseCategoryArgsObjectSchema = makeSchema();
export const CaseCountOutputTypeCountCaseCategoryArgsObjectZodSchema = makeSchema();
