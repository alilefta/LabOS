...
export const LabCountOutputTypeCountCaseWorkItemsArgsObjectSchema = makeSchema();
export const LabCountOutputTypeCountCaseWorkItemsArgsObjectZodSchema = makeSchema();
