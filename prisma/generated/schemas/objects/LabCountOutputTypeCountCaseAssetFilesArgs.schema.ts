...
export const LabCountOutputTypeCountCaseAssetFilesArgsObjectSchema = makeSchema();
export const LabCountOutputTypeCountCaseAssetFilesArgsObjectZodSchema = makeSchema();
