...
const salesrepresentativewhereinputSchema = z.object({
  AND: z.union([z.lazy(() => SalesRepresentativeWhereInputObjectSchema), z.lazy(() => SalesRepresentativeWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => SalesRepresentativeWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => SalesRepresentativeWhereInputObjectSchema), z.lazy(() => SalesRepresentativeWhereInputObjectSchema).array()]).optional(),
...
export const SalesRepresentativeWhereInputObjectSchema: z.ZodType<Prisma.SalesRepresentativeWhereInput> = salesrepresentativewhereinputSchema as unknown as z.ZodType<Prisma.SalesRepresentativeWhereInput>;
export const SalesRepresentativeWhereInputObjectZodSchema = salesrepresentativewhereinputSchema;
