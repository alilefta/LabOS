...
export const LabCountOutputTypeCountInvoiceCaseArgsObjectSchema = makeSchema();
export const LabCountOutputTypeCountInvoiceCaseArgsObjectZodSchema = makeSchema();
