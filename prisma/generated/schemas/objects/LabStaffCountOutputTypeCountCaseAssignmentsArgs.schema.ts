...
export const LabStaffCountOutputTypeCountCaseAssignmentsArgsObjectSchema = makeSchema();
export const LabStaffCountOutputTypeCountCaseAssignmentsArgsObjectZodSchema = makeSchema();
