...
export const LabCountOutputTypeCountStaffAssignmentsArgsObjectSchema = makeSchema();
export const LabCountOutputTypeCountStaffAssignmentsArgsObjectZodSchema = makeSchema();
