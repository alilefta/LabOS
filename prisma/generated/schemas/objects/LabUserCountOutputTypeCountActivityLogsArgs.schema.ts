...
export const LabUserCountOutputTypeCountActivityLogsArgsObjectSchema = makeSchema();
export const LabUserCountOutputTypeCountActivityLogsArgsObjectZodSchema = makeSchema();
