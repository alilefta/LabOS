...
export const SuperUserUpsertOneSchema: z.ZodType<Prisma.SuperUserUpsertArgs> = z.object({ select: SuperUserSelectObjectSchema.optional(),  where: SuperUserWhereUniqueInputObjectSchema, create: z.union([ SuperUserCreateInputObjectSchema, SuperUserUncheckedCreateInputObjectSchema ]), update: z.union([ SuperUserUpdateInputObjectSchema, SuperUserUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.SuperUserUpsertArgs>;

export const SuperUserUpsertOneZodSchema = z.object({ select: SuperUserSelectObjectSchema.optional(),  where: SuperUserWhereUniqueInputObjectSchema, create: z.union([ SuperUserCreateInputObjectSchema, SuperUserUncheckedCreateInputObjectSchema ]), update: z.union([ SuperUserUpdateInputObjectSchema, SuperUserUncheckedUpdateInputObjectSchema ]) }).strict();