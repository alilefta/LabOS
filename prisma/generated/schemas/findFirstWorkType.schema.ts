...
export const WorkTypeFindFirstSelectSchema: z.ZodType<Prisma.WorkTypeSelect> = z.object({
...
export const WorkTypeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    imageUrl: z.boolean().optional(),
