...
export const LabSettingsFindManySelectSchema: z.ZodType<Prisma.LabSettingsSelect> = z.object({
...
export const LabSettingsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    labId: z.boolean().optional(),
    lab: z.boolean().optional(),
    currency: z.boolean().optional(),
...
export const LabSettingsFindManySchema: z.ZodType<Prisma.LabSettingsFindManyArgs> = z.object({ select: LabSettingsFindManySelectSchema.optional(), include: z.lazy(() => LabSettingsIncludeObjectSchema.optional()), orderBy: z.union([LabSettingsOrderByWithRelationInputObjectSchema, LabSettingsOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabSettingsWhereInputObjectSchema.optional(), cursor: LabSettingsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabSettingsScalarFieldEnumSchema, LabSettingsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LabSettingsFindManyArgs>;

export const LabSettingsFindManyZodSchema = z.object({ select: LabSettingsFindManySelectSchema.optional(), include: z.lazy(() => LabSettingsIncludeObjectSchema.optional()), orderBy: z.union([LabSettingsOrderByWithRelationInputObjectSchema, LabSettingsOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabSettingsWhereInputObjectSchema.optional(), cursor: LabSettingsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabSettingsScalarFieldEnumSchema, LabSettingsScalarFieldEnumSchema.array()]).optional() }).strict();