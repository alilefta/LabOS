...
export const TechnicianFindFirstSelectSchema: z.ZodType<Prisma.TechnicianSelect> = z.object({
...
export const TechnicianFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    firstName: z.boolean().optional(),
    lastName: z.boolean().optional(),
    city: z.boolean().optional(),
...
export const TechnicianFindFirstSchema: z.ZodType<Prisma.TechnicianFindFirstArgs> = z.object({ select: TechnicianFindFirstSelectSchema.optional(), include: z.lazy(() => TechnicianIncludeObjectSchema.optional()), orderBy: z.union([TechnicianOrderByWithRelationInputObjectSchema, TechnicianOrderByWithRelationInputObjectSchema.array()]).optional(), where: TechnicianWhereInputObjectSchema.optional(), cursor: TechnicianWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicianScalarFieldEnumSchema, TechnicianScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TechnicianFindFirstArgs>;

export const TechnicianFindFirstZodSchema = z.object({ select: TechnicianFindFirstSelectSchema.optional(), include: z.lazy(() => TechnicianIncludeObjectSchema.optional()), orderBy: z.union([TechnicianOrderByWithRelationInputObjectSchema, TechnicianOrderByWithRelationInputObjectSchema.array()]).optional(), where: TechnicianWhereInputObjectSchema.optional(), cursor: TechnicianWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicianScalarFieldEnumSchema, TechnicianScalarFieldEnumSchema.array()]).optional() }).strict();