...
export const LabStaffInvitationIntentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LabStaffInvitationIntentSelect> = z.object({
...
export const LabStaffInvitationIntentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    invitationId: z.boolean().optional(),
    invitation: z.boolean().optional(),
    labId: z.boolean().optional(),
...
export const LabStaffInvitationIntentFindFirstOrThrowSchema: z.ZodType<Prisma.LabStaffInvitationIntentFindFirstOrThrowArgs> = z.object({ select: LabStaffInvitationIntentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LabStaffInvitationIntentIncludeObjectSchema.optional()), orderBy: z.union([LabStaffInvitationIntentOrderByWithRelationInputObjectSchema, LabStaffInvitationIntentOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabStaffInvitationIntentWhereInputObjectSchema.optional(), cursor: LabStaffInvitationIntentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabStaffInvitationIntentScalarFieldEnumSchema, LabStaffInvitationIntentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LabStaffInvitationIntentFindFirstOrThrowArgs>;

export const LabStaffInvitationIntentFindFirstOrThrowZodSchema = z.object({ select: LabStaffInvitationIntentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LabStaffInvitationIntentIncludeObjectSchema.optional()), orderBy: z.union([LabStaffInvitationIntentOrderByWithRelationInputObjectSchema, LabStaffInvitationIntentOrderByWithRelationInputObjectSchema.array()]).optional(), where: LabStaffInvitationIntentWhereInputObjectSchema.optional(), cursor: LabStaffInvitationIntentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LabStaffInvitationIntentScalarFieldEnumSchema, LabStaffInvitationIntentScalarFieldEnumSchema.array()]).optional() }).strict();