...
export const SuperUserUpdateOneSchema: z.ZodType<Prisma.SuperUserUpdateArgs> = z.object({ select: SuperUserSelectObjectSchema.optional(),  data: z.union([SuperUserUpdateInputObjectSchema, SuperUserUncheckedUpdateInputObjectSchema]), where: SuperUserWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.SuperUserUpdateArgs>;

export const SuperUserUpdateOneZodSchema = z.object({ select: SuperUserSelectObjectSchema.optional(),  data: z.union([SuperUserUpdateInputObjectSchema, SuperUserUncheckedUpdateInputObjectSchema]), where: SuperUserWhereUniqueInputObjectSchema }).strict();