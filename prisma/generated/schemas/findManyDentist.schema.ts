...
export const DentistFindManySelectSchema: z.ZodType<Prisma.DentistSelect> = z.object({
...
export const DentistFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    clinicId: z.boolean().optional(),
    clinic: z.boolean().optional(),
    labId: z.boolean().optional(),
