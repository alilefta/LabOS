...
export const InvoiceCaseFindFirstSelectSchema: z.ZodType<Prisma.InvoiceCaseSelect> = z.object({
...
export const InvoiceCaseFindFirstZodSchema = z.object({ select: InvoiceCaseFindFirstSelectSchema.optional(), include: z.lazy(() => InvoiceCaseIncludeObjectSchema.optional()), orderBy: z.union([InvoiceCaseOrderByWithRelationInputObjectSchema, InvoiceCaseOrderByWithRelationInputObjectSchema.array()]).optional(), where: InvoiceCaseWhereInputObjectSchema.optional(), cursor: InvoiceCaseWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InvoiceCaseScalarFieldEnumSchema, InvoiceCaseScalarFieldEnumSchema.array()]).optional() }).strict();