	...
	return (
		<div className="relative p-8 sm:p-10 w-full rounded-3xl border border-white/40 dark:border-white/10 bg-white/60 dark:bg-[#121214]/60 backdrop-blur-2xl shadow-premium animate-in fade-in slide-in-from-bottom-4 duration-700">
			...
			<div className="mb-8 text-center lg:text-left">
				<h1 className="text-2xl sm:text-3xl font-bold text-foreground tracking-tight mb-2">Welcome back</h1>
			...
			<form onSubmit={form.handleSubmit(onSubmit)} id="login-form" className="space-y-5">
				...
				<div className="space-y-1">
					<Controller
						name="password"
						control={form.control}
						render={({ field, fieldState }) => <PasswordInputWithLabel field={field} fieldState={fieldState} placeholder="••••••••" nameInSchema="password" fieldTitle="Password" />}
					/>
				</div>
