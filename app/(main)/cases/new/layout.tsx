			...
			<header className="shrink-0 flex items-center justify-between mb-8 sticky top-0 z-20 bg-background/80 backdrop-blur-md pb-4 border-b border-border/50">
				<div className="flex items-center gap-4">
					...
					<div>
						...
						<p className="text-sm text-muted-foreground mt-0.5">Define patient clinical requirements and manufacturing specs.</p>
					</div>
				</div>

				<div className="flex items-center gap-3">
					<Button variant="ghost" className="rounded-xl font-semibold text-muted-foreground hover:text-foreground">
						Save Draft
					</Button>
					<Button className="rounded-xl bg-primary text-primary-foreground px-6 font-bold shadow-premium hover:bg-primary/90">Submit Case to Production</Button>
				</div>
			</header>
