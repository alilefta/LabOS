		...
		<PermissionsProvider userContext={labUser}>
			<div className="flex flex-col h-full animate-in fade-in duration-700 bg-background">
				...
				<div className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-8 relative z-10">
					...
					<div className="absolute top-0 left-1/4 w-150 h-150 bg-primary/5 rounded-full blur-[120px] pointer-events-none -z-10 dark:block hidden"></div>

					<div className="w-full max-w-450 mx-auto flex flex-col xl:flex-row gap-8">
						...
						<div className="flex-1 space-y-8 min-w-0">
							...
							<div className="h-96 rounded-3xl border-2 border-dashed border-border flex items-center justify-center bg-slate-50/50 dark:bg-white/2">
