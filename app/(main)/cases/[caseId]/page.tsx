		...
		<PermissionsProvider userContext={labUser}>
			<div className="flex flex-col h-full animate-in fade-in duration-700 bg-background relative overflow-hidden">
				...
				<div className="flex-1 overflow-y-auto custom-scrollbar relative z-10 w-full">
					...
					<div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-125 bg-primary/5 rounded-full blur-[120px] pointer-events-none -z-10 hidden dark:block" />

					<div className="w-full max-w-400 mx-auto flex flex-col xl:flex-row gap-8 p-4 sm:p-6 lg:p-8">
